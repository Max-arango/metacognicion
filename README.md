...
**claude.ai / Claude Desktop:** descarga el zip desde
[Releases](https://github.com/Max-arango/metacognicion/releases) (o comprime este repo, con
`SKILL.md` en la raíz) y súbelo en Ajustes → Capacidades → Skills.
